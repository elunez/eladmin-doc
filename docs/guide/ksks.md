...
![](https://img.el-admin.xin/20200609184434.png)
...
![](https://img.el-admin.xin/20200609184548.png)

打开数据库，创建一个新库 `eladmin`，导入sql文件夹中的初始化脚本库脚本 `eladmin.sql`

![](https://img.el-admin.xin/20200609184722.png)

修改配置，如果你的数据库密码不是 123456，那么需要在 dev.yml 配置文件中做相应的修改

![](https://img.el-admin.xin/20200609185014.png)
...
![](https://img.el-admin.xin/20200609185424.png)

打开Eclipse，工作空间设置为该目录

![](https://img.el-admin.xin/20200609185609.png)

导入我们的的项目 File -> Import

![](https://img.el-admin.xin/20200609185730.png)

选择 Maven ，然后 Next

![](https://img.el-admin.xin/20200609185818.png)

选择项目的目录，然后 Finish

![](https://img.el-admin.xin/20200609185940.png)
...
![](https://img.el-admin.xin/20200609190325.png)

解决 Lombok 的问题后，进入 eladmin-system 模块中的 AppRun，点击启动按钮启动程序

![](https://img.el-admin.xin/20200609190602.png)

这时会有一个新的问题，那就是 mapstruct 的实现类不会自动生成，报错如下

![](https://img.el-admin.xin/20200609190817.png)
...
![](https://img.el-admin.xin/20200609191851.png)
...
![](https://img.el-admin.xin/20200609192055.png)

导入数据库，修改数据库配置，这个步骤参考上面 Idea 教程的步骤

![](https://img.el-admin.xin/20200609192230.png)

点击启动按钮旁边的小按钮，然后选择 `Maven Install` 生成 mapstruct 的实现类

![](https://img.el-admin.xin/20200609192922.png)

查看 target -> generated-sources 目录是否生成了 mapstruct 的实现类

![](https://img.el-admin.xin/20200609193210.png)

这个时候启动项目，就不会报错了，至此教程结束

![](https://img.el-admin.xin/20200609193456.png)
...
![](https://img.el-admin.xin/20200609194318.png)

打开 WebStorm，导入我们的项目

![](https://img.el-admin.xin/20200609194432.png)

这个时候 WebStorm 会在右下角提示我们安装依赖

![](https://img.el-admin.xin/20200609194535.png)

也可以手动在 Terminal 中输入 `npm install` 进行安装

![](https://img.el-admin.xin/20200609194723.png)

依赖安装完成后，打开 package.json 找到 dev 旁边的启动按钮

![](https://img.el-admin.xin/20200609194958.png)
