...
module.exports = {
  sidebarT: `
      <a href="https://bwhstock.in/" target="_blank" style="margin-top: -8px;">
        <img src="/images/banner/side.jpeg" alt="VPS推荐" width="246px" height="72px">
      </a>
      <a href="https://bwhstock.in/" style="text-align: center;margin-top: 2px;margin-bottom:0;display:block;color: #999;font-size: 12px;">🌈 无需备案，境外服务器推荐</a>
  `,
  // 万维
  windowRB: `
