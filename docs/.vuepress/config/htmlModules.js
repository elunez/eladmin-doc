...
module.exports = {
  sidebarT: `
      <a href="https://bwhstock.in/" style="margin-top: -8px;" target="_blank">
        <img src="/images/banner/side.jpeg" alt="搬瓦工" width="243px" height="70px">
      </a>
      <a href="https://bwhstock.in/" style="text-align: center;margin-top: 2px;margin-bottom:0;display:block;color: #999;font-size: 12px;" target="_blank">☁️ 境外稳定建站,点我查看所有库存方案 ☁️</a>
  `,
  // 万维
  windowRB: `
